	...
	() => {
		test('Login to App as a standard user', async ({
			...
			await test.step(
				...
				async () => {
					await productDetailsPage.clickAddToCartButtononItemPage()
			...
			await test.step(
				...
				async () => {
					await productDetailsPage.clickRemoveButtonProductPage()
			...
			await test.step(
				...
				async () => {
					...
					// await productsPage.clickRemoveButtonProductPage()
