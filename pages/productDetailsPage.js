...
import {
	...
	addToCartButton,
	removeButton,
	addToCartButtonItemPage,
	removeButtonProductPage
...
class ProductDetailsPage extends BasePage {
	...
	async clickAddToCartButtononItemPage() {
		await this.isElementEnabled(addToCartButtonItemPage, testData.notEnabledText)
		return await this.waitAndClick(addToCartButtonItemPage)
	}
	...
	async clickRemoveButtonProductPage() {
		await this.isElementEnabled(removeButtonProductPage, testData.notEnabledText)
		return await this.waitAndClick(removeButtonProductPage)
	}
